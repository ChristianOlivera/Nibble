...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Confirmación de eliminación de <?php echo e($news->title); ?> <?php $__env->endSlot(); ?>
    ...
    <section class="container-fluid mb-5">
        ...
        <div class="card mb-3">
            <?php if($news->image !== null && \Storage::exists($news->image)): ?>
                <img src="<?php echo e(Storage::url($news->image)); ?>" class="card-img-top" alt="<?php echo e($news->description_image); ?>">                 
            <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\Parcial2\resources\views/news/delete-form.blade.php ENDPATH**/ ?>