...
<?php $component->withAttributes([]); ?>
    ...
    <section class="container-fluid mb-5">
        ...
        <div class="form-container">
            <form action="<?php echo e(route('news.create.process')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    <label for="image" class="form-label text-white fs-5">Imagen (url):</label>
                    <input type="url" class="form-control bg-dark text-white" id="image" name="image" accept="image/*" value="<?php echo e(old('image')); ?>">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\Parcial1\resources\views/news/create-form.blade.php ENDPATH**/ ?>