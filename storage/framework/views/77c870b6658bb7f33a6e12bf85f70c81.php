      ...
      <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col">
          <div class="card h-100 bg-dark">
            ...
            <div class="card-body">
              <h5 class="card-title text-center text-white">SIMPLE CHEESEBURGER</h5>
        ...
        <div class="col">
          <div class="card h-100 bg-dark">
            ...
            <div class="card-body">
              <h5 class="card-title text-center text-white">DOBLE CHEESEBURGER</h5>
        ...
        <div class="col">
          <div class="card h-100 bg-dark">
            ...
            <div class="card-body">
              <h5 class="card-title text-center text-white">TRIPLE CHEESEBURGER</h5>
        ...
        <div class="col">
          <div class="card h-100 bg-dark">
            ...
            <div class="card-body">
              <h5 class="card-title text-center text-white">LEVEL ONE</h5>
        ...
        <div class="col">
          <div class="card h-100 bg-dark">
            ...
            <div class="card-body">
              <h5 class="card-title text-center text-white">LEVEL TWO</h5>
        ...
        <div class="col">
          <div class="card h-100 bg-dark">
            ...
            <div class="card-body">
              <h5 class="card-title text-center text-white">EXTRA LEVEL</h5>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel\Parcial1\resources\views/menu.blade.php ENDPATH**/ ?>