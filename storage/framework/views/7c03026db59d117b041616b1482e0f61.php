        ...
        <div class="register-container">
            <form action="<?php echo e(route('auth.register.process')); ?>" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" class="form-control bg-dark text-white p-2 mb-2" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" class="form-control bg-dark text-white p-2 mb-2" value="<?php echo e(old('email')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel\Parcial2\resources\views/auth/register-form.blade.php ENDPATH**/ ?>