...
<?php $component->withAttributes([]); ?>
    ...
    <section class="container-fluid mb-5">
        ...
        <div class="form-container">
            <form action="<?php echo e(route('news.edit.process', ['id' => $news->news_id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="url" class="form-control bg-dark text-white" id="image" name="image" accept="image/*" value="<?php echo e(old('image', $news->image)); ?>">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\Parcial1\resources\views/news/edit-form.blade.php ENDPATH**/ ?>