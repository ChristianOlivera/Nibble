...
<head>
    ...
    <link rel="icon" href="<?php echo e(url('img/favicon.png')); ?>" type="image/png" sizes="32px">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo02">
            <ul class="navbar-nav text-end px-2 mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a id="login-button" class="nav-link" href="<?php echo e(route('auth.login.form')); ?>">Login <i class="fa-solid fa-arrow-right-to-bracket"></i></a>
                </li>
                <?php else: ?>
                <li class="nav-item">
                    <form action="<?php echo e(route('auth.logout.process')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <button class="nav-link">Logout <i class="fa-solid fa-arrow-right-from-bracket"></i></button>
                    </form>
                </li>
                <?php endif; ?>
          </div>
...
<?php /**PATH C:\xampp\htdocs\laravel\Parcial1\resources\views/components/layout.blade.php ENDPATH**/ ?>